...
Создадим файл ex2.asm для 2-го задания

![Рис 3.2.1: Демонстрация 19-го варианта](image/Рис 3.2.1.png)

Напишем программу, которая для введенных с клавиатуры значений x и a вычисляет значение заданной функции f(x)

![Рис 3.2.2: (1)Программа для задания](image/Рис 3.2.2.png)

![Рис 3.2.3: (2)Программа для задания](image/Рис 3.2.3.png)

Проверим работу программы

![Рис 3.2.4: Проверка программы](image/Рис 3.2.4.png)

Как видно по (Рис 3.2.4) программа работает верно
